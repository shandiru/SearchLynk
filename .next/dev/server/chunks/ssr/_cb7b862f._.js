...
const metadata = {
    ...
    description: "Fast SEO-friendly websites, technical optimization, and GA4 analytics for small European businesses. Founded by Dirushan, a Software Engineering graduate.",
    generator: "v0.app",
    icons: {
        icon: [
            {
